...
import { SupplierOrderEditProvider } from '@/modules/admin/supplier-orders/components/supplier-order-detail/edit-supplier-order-modal/context';
import SupplierOrdersDetail from '@/modules/admin/supplier-orders/templates/supplier-orders-detail';
