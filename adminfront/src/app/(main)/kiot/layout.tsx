...
import Header from '@/modules/kiot/common/components/header';
...
import Notification from '@/modules/kiot/common/components/notification';
import { LayeredModalProvider } from '@/lib/providers/layer-modal-provider';

export default async function KiotLayout({
	children,
}: Readonly<{
