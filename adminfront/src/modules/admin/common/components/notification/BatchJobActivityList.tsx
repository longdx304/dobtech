...
import ActivityCard from '@/modules/admin/common/components/activity-card';
import BatchJobFileCard from '@/modules/admin/common/components/batch-job-file-card';
