...
import BackToOrders from '@/modules/admin/supplier-orders/components/supplier-order-detail/back-to-orders';
import Information from '@/modules/admin/supplier-orders/components/supplier-order-detail/information';
import Summary from '@/modules/admin/supplier-orders/components/supplier-order-detail/summary';
