...
import GeneralForm from '@/modules/admin/products/components/products-modal/components/GeneralForm';
import OrganizeForm from '@/modules/admin/products/components/products-modal/components/OrganizeForm';
