...
import Images from '@/modules/admin/products/components/product-detail/components/Images';
import GeneralInfo from '@/modules/admin/products/components/product-detail/components/GeneralInfo';
import AttributesInfo from '@/modules/admin/products/components/product-detail/components/AttributesInfo';
