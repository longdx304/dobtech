...
const DrawCategory: FC<Props> = ({ open, onClose, categories }) => {
	const [hoveredItem, setHoveredItem] = useState<string>(categories[0]?.id);
	...
	return (
		<Drawer placement="left" title="Danh mục" onClose={onClose} open={open} className="[&_.ant-drawer-body]:p-0">
			<CategoryMenu
